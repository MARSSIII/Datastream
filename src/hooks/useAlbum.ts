...
const mockAlbums: Album[] = [
  ...
  },
  {
    ...
    tracklist: [
      ...
      { id: 2, trackNumber: 2, plays: 2, size: '25.15 MB', genres: ['classical'], title: '01 Schwanengesang, D. 957_ IV. Ständchen (v0.10.27.slw)', artist: '1000 Eyes', src: '/music/02 Schwanengesang, D. 957_ IV. Ständchen (v0.10.27).flac', cover: '/covers/Schwanengesang.png', duration: '02:33', quality: 'FLAC' }
    ],
    trackCount: 0,
    duration: '0',
    size: '0 MB'
